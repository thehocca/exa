...
class Redis365 {
    constructor() {
        if (!Redis365.instance) {

            this.connectObject = {
                host: process.env.REDIS_365_IP,
                port: process.env.REDIS_365_PORT,
                auth_pass: process.env.REDIS_365_PASS
            };
            ...
            this.client
                ...
                .on('connect', () => {
                    console.log("365 REDIS CONNECTION SUCCESS...")
                });
            ...
            this.subscriber
                ...
                .on('connect', () => {
                    console.log("365 REDIS SUBSCRIBER CONNECTED...");
                });
            ...
            Redis365.instance = this;
        }

        return Redis365.instance;
    }
...
const redis365 = new Redis365();
Object.freeze(redis365);

module.exports = { redis365 };
