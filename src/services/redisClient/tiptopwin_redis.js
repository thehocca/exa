...
class RedisTiptopwin {
    constructor() {
        if (!RedisTiptopwin.instance) {

            this.connectObject = {
                host: process.env.REDIS_tiptopwin_IP,
                port: process.env.REDIS_tiptopwin_PORT,
                auth_pass: process.env.REDIS_tiptopwin_PASS
            };
            ...
            this.client
                ...
                .on('connect', () => {
                    console.log("Tiptopwin REDIS CONNECTION SUCCESS...")
                });
            ...
            this.subscriber
                ...
                .on('connect', () => {
                    console.log("Tiptopwin REDIS SUBSCRIBER CONNECTED...");
                });
            ...
            RedisTiptopwin.instance = this;
        }

        return RedisTiptopwin.instance;
    }
...
const redisTiptopwin = new RedisTiptopwin();
Object.freeze(redisTiptopwin);

module.exports = { redisTiptopwin };
