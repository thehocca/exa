...
class RedisStarwin {
    constructor() {
        if (!RedisStarwin.instance) {

            this.connectObject = {
                host: process.env.REDIS_Starwin_IP,
                port: process.env.REDIS_Starwin_PORT,
                auth_pass: process.env.REDIS_Starwin_PASS
            };
            ...
            this.client
                ...
                .on('connect', () => {
                    console.log("Starwin REDIS CONNECTION SUCCESS...")
                });
            ...
            this.subscriber
                ...
                .on('connect', () => {
                    console.log("Starwin REDIS SUBSCRIBER CONNECTED...");
                });
            ...
            RedisStarwin.instance = this;
        }

        return RedisStarwin.instance;
    }
...
const redisStarwin = new RedisStarwin();
Object.freeze(redisStarwin);

module.exports = { redisStarwin };
