...
class RedisTipx {
    constructor() {
        if (!RedisTipx.instance) {

            this.connectObject = {
                host: process.env.REDIS_Tipx_IP,
                port: process.env.REDIS_Tipx_PORT,
                auth_pass: process.env.REDIS_Tipx_PASS
            };
            ...
            this.client
                ...
                .on('connect', () => {
                    console.log("Tipx REDIS CONNECTION SUCCESS...")
                });
            ...
            this.subscriber
                ...
                .on('connect', () => {
                    console.log("Tipx REDIS SUBSCRIBER CONNECTED...");
                });
            ...
            RedisTipx.instance = this;
        }

        return RedisTipx.instance;
    }
...
const redisTipx = new RedisTipx();
Object.freeze(redisTipx);

module.exports = { redisTipx };
